...
python scripts/nano_postproc_custom.py tmp/ ${ifile} -I PhysicsTools.NanoNN.inputProducer InputProducer --cut "FatJet_pt>300" -N ${nentries} --bi scripts/branch_inputs.txt --bo scripts/branch_inputs_output.txt --perJet
