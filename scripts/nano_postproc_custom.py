#!/usr/bin/env python
from PhysicsTools.NanoAODTools.postprocessing.framework.postprocessor_custom import CustomPostProcessor
...
if __name__ == "__main__":
    ...
    parser.add_option("--perJet", dest="perJet", default=False,
                      action="store_true", help="Fill the output tree of the module per Jet")
    ...
    p = CustomPostProcessor(outdir, args,
                            cut=options.cut,
